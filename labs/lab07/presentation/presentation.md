...
![Создадим каталог с именем equipment в каталоге ~/ski.plases](image/19.png){#fig:019 width=70%}
...
![Проверим](image/37.png){#fig:037 width=50%}

Проанализируем man mount 

![Проверим](image/38.png){#fig:038 width=40%}

## Введем man fsck 

![Проверим](image/39.png){#fig:039 width=50%}

Проанализируем man fsck 

![Проверим](image/40.png){#fig:040 width=40%}

## Введем man mkfs 

![Проверим](image/41.png){#fig:041 width=50%}

Проанализируем man mkfs 

![Проверим](image/42.png){#fig:042 width=40%}

## Введем man kill 

![Проверим](image/43.png){#fig:043 width=50%}

Проанализируем man kill

![Проверим](image/44.png){#fig:044 width=40%}
